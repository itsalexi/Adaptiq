...
export default function DashboardMain({
    ...
    return (
        <section className="flex-1 p-4 md:p-10 bg-white dark:bg-gray-900 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-2xl md:text-3xl font-bold mb-2 text-gray-900 dark:text-white mt-14 md:mt-0">
                    Good Evening,{' '}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    {topics.map((topic) => (
                        <div
                            ...
                            className="bg-white dark:bg-gray-800 rounded-lg p-4 md:p-6 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors relative group border border-gray-200 dark:border-gray-700"
                        >
                    ...
                    >
                        <FiFolderPlus className="text-2xl md:text-3xl text-gray-400 mb-2" />
                ...
                {topics.length === 0 && (
                    <div className="text-center py-8 md:py-12">
                        <FiBookOpen className="text-5xl md:text-6xl text-gray-300 dark:text-gray-600 mx-auto mb-4" />
                        <h3 className="text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">
                            No topics yet
                        </h3>
                        <p className="text-gray-500 dark:text-gray-400 mb-6">
                            Create your first topic to start your learning
                            journey
                        </p>
                        <button
                            onClick={onCreateTopic}
                            className="px-4 md:px-6 py-2 md:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold"
                        >
